...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_APawnWithCamera_Statics::NewProp_OurCameraSpringArm = { "OurCameraSpringArm", nullptr, (EPropertyFlags)0x0020080000080009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APawnWithCamera, OurCameraSpringArm), Z_Construct_UClass_USpringArmComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_APawnWithCamera_Statics::NewProp_OurCameraSpringArm_MetaData, ARRAY_COUNT(Z_Construct_UClass_APawnWithCamera_Statics::NewProp_OurCameraSpringArm_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_APawnWithCamera_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_APawnWithCamera_Statics::PropPointers),
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_APawnWithCamera_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_APawnWithCamera_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(APawnWithCamera, 1399030359);
	template<> HOWTO_PLAYERCAMERA_API UClass* StaticClass<APawnWithCamera>()
	{
		return APawnWithCamera::StaticClass();
	}
