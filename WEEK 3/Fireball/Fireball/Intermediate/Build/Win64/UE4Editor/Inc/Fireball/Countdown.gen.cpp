...
// Cross Module References
	FIREBALL_API UClass* Z_Construct_UClass_ACountdown_NoRegister();
	FIREBALL_API UClass* Z_Construct_UClass_ACountdown();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_Fireball();
	FIREBALL_API UFunction* Z_Construct_UFunction_ACountdown_CountdownHasFinished();
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACountdown_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ACountdown_CountdownHasFinished, "CountdownHasFinished" }, // 3205837873
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_ACountdown_Statics::NewProp_CountdownTime = { "CountdownTime", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACountdown, CountdownTime), METADATA_PARAMS(Z_Construct_UClass_ACountdown_Statics::NewProp_CountdownTime_MetaData, ARRAY_COUNT(Z_Construct_UClass_ACountdown_Statics::NewProp_CountdownTime_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ACountdown_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_ACountdown_Statics::PropPointers),
		0,
		0x009000A0u,
	...
	IMPLEMENT_CLASS(ACountdown, 827234974);
	template<> FIREBALL_API UClass* StaticClass<ACountdown>()
	{
		return ACountdown::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ACountdown(Z_Construct_UClass_ACountdown, &ACountdown::StaticClass, TEXT("/Script/Fireball"), TEXT("ACountdown"), false, nullptr, nullptr, nullptr);
